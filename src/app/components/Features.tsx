    ...
    <section ref={sectionRef} className="py-20 px-6 bg-white">
      <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-lg text-gray-600">
          ...
          Explore our range crafted with love, backed by science, and inspired by nature.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        <div className="feature-item p-6 rounded-lg bg-gray-50">
          ...
          <p className="text-gray-600">
            Get naturally beautiful and transform with our bio ingredients for healthy, radiant skin.
          </p>
        </div>
